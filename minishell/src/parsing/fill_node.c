...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2025/04/13 15:53:17 by arimoham          #+#    #+#             */
/*   Updated: 2025/04/23 11:46:21 by rradin-m         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static t_mini	*get_params(t_mini *node, char **a[2], int *i)
{
	if (a[0][*i])
	{
		if (a[0][*i][0] == '>' && a[0][*i + 1] && a[0][*i + 1][0] == '>')
			...
			node->full_cmd = ft_extend_array(node->full_cmd, a[1][*i]);
		else
		{
